  ...
  <div>
                                          ...
                                          <ul role="list" class="-mx-2 space-y-1">
                                              <li v-for="item in navigation" :key="item.name">
                                                  ...
                                                  <Disclosure as="div" v-else v-slot="{ open }">
                                                      <DisclosureButton
                                                          :class="[item.current ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800', 'group flex items-center w-full text-left rounded-md p-2 gap-x-3 text-sm leading-6 font-semibold text-gray-400']">
                                                          <component :is="item.icon"
      ...
      <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-black px-6 pb-4">
              <div class="flex h-12 w-20 mt-4 ml-16 rounded-lg pl-2 pr-2 shrink-0 items-center bg-black">
                  <h1 class="text-white">DIGBICK</h1>
              </div>
              <br>
                          ...
                          <ul role="list" class="-mx-2 space-y-1">
                              <li v-for="item in navigation" :key="item.name">
                                  <a v-if="!item.children" @click="navigateTo(item.href)"
                                      :class="[item.current ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800', 'cursor-pointer first-line:group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold']">
      ...
      <div class="lg:pl-72">
                  ...
                  <div class="flex items-center gap-x-4 lg:gap-x-6">
                      ...
                      <Menu as="div" class="relative">
                          <MenuButton class="-m-1.5 flex items-center p-1.5">
                              ...
                              <div class="h-8 w-8 rounded-full bg-black flex justify-center items-center">
                                  <h1 class="text-center font-extrabold text-white">VDL</h1>
                              </div>

                                  
                              <span class="hidden lg:flex lg:items-center">
                                  <span class="ml-4 text-sm font-semibold leading-6 text-gray-900"
                                      aria-hidden="true">Venn
                                      Lopez</span>
          ...
          <main class="py-10">
              <div class="px-4 sm:px-6 lg:px-8">
                  <!-- Your content -->
                  <div class="h-96 w-22 bg-black relative">
                    <img src="../Images/shovel.jpg" alt="Shovel" class="object-fit absolute inset-0 w-full h-full">
                  </div>
                  <slot />
              </div>
          </main>
...
const navigation = [
  ...
  { name: 'Contact', href: '/contactspage', },
  // {
  //     name: 'Teams',
  //     icon: UsersIcon,
  //     current: false,
